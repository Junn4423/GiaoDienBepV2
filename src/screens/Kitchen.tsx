...
// Thêm nút quay lại màn hình chính trong header
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Khu vực Bếp</Text>
          <TouchableOpacity style={styles.switchButton} onPress={navigateToBar}>
            <MaterialIcons name="swap-horiz" size={20} color="#fff" />
            <Text style={{ color: "#fff", fontWeight: "bold", marginLeft: 4 }}>Về Bar</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.menuGrid}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("GroupedItems", { area: "kitchen" })}
          >
            <View style={styles.menuIcon}>
              <MaterialIcons name="restaurant" size={32} color="#5c6bc0" />
            </View>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => navigation.navigate("CompletedItems", { area: "kitchen" })}
          >
            <View style={styles.menuIcon}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => navigation.navigate("AllItems", { area: "kitchen" })}
          >
            <View style={styles.menuIcon}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => navigation.navigate("OccupiedTables", { area: "kitchen" })}
          >
            <View style={styles.menuIcon}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => navigation.navigate("EmptyTables", { area: "kitchen" })}
          >
            <View style={styles.menuIcon}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => navigation.navigate("WaitingTables", { area: "kitchen" })}
          >
            <View style={styles.menuIcon}>
...
// Cập nhật styles cho header và thêm style cho nút back
