...
type WaitingTablesScreenRouteProp = RouteProp<RootStackParamList, "WaitingTables">

const WaitingTablesScreen: React.FC = () => {
  const route = useRoute<WaitingTablesScreenRouteProp>()
  ...
  useEffect(() => {
    ...
    // Lọc các bàn chờ
    const waitingTables = getTablesByStatus(allTables, "waiting")
    setTables(waitingTables)
  }, [area])
...
export default WaitingTablesScreen
