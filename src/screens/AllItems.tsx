...
import { generateMockItems, generateMockTables, getPendingItems, getItemsByTable } from "../data/mockData"

type RootStackParamList = {
  AllItems: { area: "kitchen" | "bar" }
}

type AllItemsScreenRouteProp = RouteProp<RootStackParamList, "AllItems">

const AllItemsScreen: React.FC = () => {
  const route = useRoute<AllItemsScreenRouteProp>()
  ...
  const handleSelectTable = (tableId: string) => {
    ...
    if (selectedTable && selectedTable.status !== "empty" && tableItems.length > 0) {
