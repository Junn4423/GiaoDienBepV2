...
// Thêm nút quay lại màn hình chính trong bottom navigation
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={navigateToMainSelection}>
          <MaterialIcon name="exit-to-app" size={24} color="#f44336" />
          <Text style={[styles.navText, { color: "#f44336" }]}>Thoát</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  )
